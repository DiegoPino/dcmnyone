...
/*  $form['simple']['#type'] = 'actions';
  ...
  <div class="input-group"> 
      ...
      <select class="selectpicker form-select" data-width="fit" aria-describedby="basic-addon2" id="edit-collection-select" data-header="Select a Collection" name="collection_select"><option value="all">All Collections</option>
   ...
   <!--  Input field and button -->
    ...
    <input placeholder="Search our repository" class="form-text" type="text" aria-describedby="basic-addon2" id="edit-islandora-simple2-search-query" name="islandora_simple_search_query" value="" size="30" maxlength="128">
